...
class _ExhibitionBottomSheetState extends State<ExhibitionBottomSheet>
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  SheetHeader(
                    fontSize: headerFontSize ?? 0.0,
                    topMargin: headerTopMargin ?? 0.0,
                  ),
    ...
    return Positioned(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.horizontal(
          left: Radius.circular(iconLeftBorderRadius ?? 0.0),
          right: Radius.circular(iconRightBorderRadius ?? 0.0),
        ),
        child: Image.asset(
          'assets/${event.assetName}',
          fit: BoxFit.cover,
          alignment: Alignment(lerp(1, 0) ?? 0.0, 0),
        ),
      ),
    );
  }
  ...
  Widget _buildFullItem(Event event) {
    ...
    return ExpandedEventItem(
      ...
      leftMargin: iconLeftMargin(index) ?? 0.0,
      height: iconSize ?? 0.0,
      isVisible: _controller.status == AnimationStatus.completed,
      borderRadius: itemBorderRadius ?? 0.0,
      title: event.title,
      date: event.date,
    );
  }
