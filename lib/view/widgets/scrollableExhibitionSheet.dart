...
import 'package:transitions/view/widgets/sheetHeader.dart';
...
class ScrollableExhibitionSheet extends StatefulWidget {
  ...
  @override
  State<ScrollableExhibitionSheet> createState() =>
...
class MyEventItem extends StatelessWidget {
  ...
  const MyEventItem(
      {super.key, required this.event, required this.percentageCompleted});
